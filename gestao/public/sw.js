...
const CACHE = "lcr-static-v2";
const STATIC = /\/(_next\/static|icon-|apple-touch-icon|assets)\//;
// Em desenvolvimento os chunks do Turbopack mantêm o mesmo nome entre builds —
// cachear aqui faz o navegador exibir CSS/JS velhos. Só cacheia em produção.
